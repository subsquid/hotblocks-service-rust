...
CN-5 says two sequential reads by one client observe non-decreasing versions. FM-34
...
**Instance** is the unit for CN-5, and it is additionally per epoch. Cross-instance
...
restart (CN-7), so no new client burden appears in practice.
...
Shapes REQ-11, INV-12, CN-5, WP-20, FM-26, FM-34.
